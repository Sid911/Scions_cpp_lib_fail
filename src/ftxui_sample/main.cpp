...
// configuration step. It creates a namespace called `Scions`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Scions::cmake::project_name, Scions::cmake::project_version) };
