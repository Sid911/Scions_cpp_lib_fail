...
public:
    ...
    constexpr TensorAddOpDesc(const size_t &input1,
        ...
        : OpDesc(TENSOR_ADD_OP_ID, {
        input1 + 1, input2 + 1
    }, { output1 + 1 }, "Tensor Add Op") {}
};
...
public:
    ...
    constexpr TensorSubtractOpDesc(const size_t &input1,
                                   const size_t &input2,
                                   const size_t &output1)
        : OpDesc(TENSOR_SUBTRACT_OP_ID, {
        input1 + 1, input2 + 1
    }, { output1 + 1 }, "Tensor Subtract Op") {}
};
...
public:
    ...
    constexpr TensorMultiplyOpDesc(const size_t &input1,
                                   const size_t &input2,
                                   const size_t &output1)
        : OpDesc(TENSOR_MULTIPLY_OP_ID, {
        input1 + 1, input2 + 1
    }, { output1 + 1 }, "Tensor Multiply Op") {}
};
...
public:
    ...
    constexpr TensorDivideOpDesc(const size_t &input1,
                                 const size_t &input2,
                                 const size_t &output1)
        : OpDesc(TENSOR_DIVIDE_OP_ID, {
        input1 + 1, input2 + 1
    }, { output1 + 1 }, "Tensor Divide Op") {}
};
...
public:
    ...
    constexpr TensorExponentiateOpDesc(const size_t &input1,
                                       const size_t &input2,
                                       const size_t &output1)
        : OpDesc(TENSOR_EXPONENTIATION_OP_ID, {
        input1 + 1, input2 + 1
    }, { output1 + 1 }, "Tensor Exponentiate Op") {}
};
...
public:
    ...
    constexpr TensorLogOpDesc(const size_t &input1,
                              const size_t &output1)
        : OpDesc(TENSOR_LOG_OP_ID, {
        input1 + 1
    }, { output1 + 1 }, "Tensor Log Op") {}
};
...
public:
    ...
    constexpr TensorSquareRootOpDesc(const size_t &input1,
                                     const size_t &output1)
        : OpDesc(TENSOR_SQUARE_ROOT_OP_ID, {
        input1 + 1
    }, { output1 + 1 }, "Tensor Square Root Op") {}
};
...
public:
    ...
    constexpr TensorMeanOpDesc(const size_t &input1,
                               const size_t &output1)
        : OpDesc(TENSOR_MEAN_OP_ID, {
        input1 + 1
    }, { output1 + 1 }, "Tensor Mean Op") {}
};
